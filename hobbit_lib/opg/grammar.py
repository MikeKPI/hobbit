...
grammar_elements = OrderedDict([
    ...
    ('<operator_lv1>', create_non_terminal('<operator_lv1>')),
    ('<multiplier>', create_non_terminal('<multiplier>')),
    ('<mp_body>', create_non_terminal('<mp_body>')),
    ('<operator_lv2>', create_non_terminal('<operator_lv2>')),
    ('<+>', create_non_terminal('<+>')),
    ('<->', create_non_terminal('<->')),
...
grammar = OrderedDict(
    [
        ...
        rule_creator(token='<arithmetic_expression>', args=[['ID', '=', '<arithmetic_expression_body>']]),
        rule_creator(token='<arithmetic_expression_body>', args=[['<arithmetic_expression_body1>']]),
        rule_creator(token='<arithmetic_expression_body1>', args=[['<term>'],
                                                                  ['<term>', '<operator_lv1>', '<arithmetic_expression_body1>']]),
        rule_creator(token='<term>', args=[['<multiplier>'],
                                           ['<multiplier>', '<operator_lv2>', '<term>']]),
        rule_creator(token='<multiplier>', args=[['<mp_body>'],
                                                 ['<operator_lv1>', '<mp_body>']]),
        rule_creator(token='<mp_body>', args=[['(', '<arithmetic_expression_body>', ')'],
                                              ['<value>']]),
        rule_creator(token='<value>', args=[['ID'],
                                            ['CONST']]),
        rule_creator(token='<operator_lv1>', args=[['<+>'],
                                                   ['<->']]),
        rule_creator(token='<operator_lv2>', args=[['*'],
                                                   ['/'],
                                                   ['%']]),
        rule_creator(token='<for_cycle>', args=[
            ['for', '<arithmetic_expression>', 'to', '<arithmetic_expression_body>', 'do', '<block>']]),
